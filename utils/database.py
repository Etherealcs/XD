...
DETA_KEY = "QyProdnX_jogSUfQZifNyPXC43zGsjQSxLfRCphzD"
...
def insert_user(email, name, password):
    ...
    return db.put({"email_lower": email.lower(), "email": email, "name": name, 
            "password": hashed_password, "salt": salt}, key=email.lower())
